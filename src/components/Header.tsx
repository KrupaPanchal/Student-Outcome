        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between py-4 gap-4">
          ...
          <div className="flex items-center flex-wrap gap-2.5">
            ...
            <button
              ...
              title="Click to view MongoDB status, diagnostic report &amp; setup"
            ...
            >
              <Database className={`w-3.5 h-3.5 ${dbStatus.isMongo ? 'text-emerald-600' : dbStatus.mongoConfigured ? 'text-amber-600' : 'text-indigo-600'}`} />
              <span>
                {dbStatus.isMongo
                  ? 'MongoDB Active'
                  : dbStatus.mongoConfigured
                  ? 'Local Storage (MongoDB Offline)'
